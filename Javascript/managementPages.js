function ShowUser(jsonValues) {
    ...
    document.getElementById("user-pageTitle").innerHTML = "<button onclick='OpenDashboard(0)'>&#129044;</button>" + user.prenom + " " + user.nom;
...
function ShowTicket(jsonValues) {
    ...
    document.getElementById("ticket-pageTitle").innerHTML = "<button onclick='OpenDashboard(1)'>&#129044;</button>" + ticket.title;
